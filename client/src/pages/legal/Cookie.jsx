        ...
        <div className="space-y-10 rounded-3xl border border-gray-200 p-10 shadow-sm">
          ...
          <div>
            ...
            <p className="leading-8 text-gray-600">
              ...
              a website. They help improve user experience, remember
          ...
          <div>
            ...
            <p className="leading-8 text-gray-600">
              Some third-party services such as analytics tools or
              authentication providers may use cookies to provide additional
