  ...
  return (
    <div className="min-h-screen bg-white px-6 py-16 md:px-20">
      <div className="mx-auto max-w-5xl">
        ...
        {/* Overall Status */}
        <div className="mb-10 rounded-3xl border border-green-200 bg-green-50 p-8 text-center">
        ...
        {/* Maintenance */}
        <div className="mt-10 rounded-3xl border border-yellow-200 bg-yellow-50 p-8">
          <h2 className="mb-4 text-2xl font-semibold text-yellow-800">
            Scheduled Maintenance
          </h2>

          <p className="leading-7 text-yellow-700">
            No scheduled maintenance at the moment. Future maintenance
            updates and downtime notifications will appear here.
          </p>
        </div>
